...
const HELP = [
  ...
  "smTest('bevel')    // valence-3 box edge; select the logged vertical edge, then Bevel",
  "smTest('bevel-valence') // valence-4 endpoints; reproduces/tests higher-valence Bevel",
  "smTest('extrude-normal') // tilted quad; Face Extrude must follow its surface normal",
