...
export const NodeRegistry: Record<string, NodeDefinition> = {
    ...
    'TwoBoneIK': {
        ...
        inputs: [
            { id: 'pose', name: 'In Pose', type: 'pose' },
            { id: 'target', name: 'Target', type: 'vec3' }
        ],
        outputs: [{ id: 'outPose', name: 'Out Pose', type: 'pose' }],
        data: { root: 'Thigh_L', mid: 'Calf_L', eff: 'Foot_L' }
    },
    'GreaterThan': {
        type: 'GreaterThan', category: 'Logic', title: 'Greater Than',
        inputs: [{ id: 'a', name: 'A', type: 'float' }, { id: 'b', name: 'B', type: 'float' }],
        outputs: [{ id: 'out', name: 'Result', type: 'boolean' }],
    ...
    'Branch': {
        ...
        inputs: [
            ...
            { id: 'true', name: 'True', type: 'pose' },
            { id: 'false', name: 'False', type: 'pose' }
        ],
        outputs: [{ id: 'out', name: 'Out Pose', type: 'pose' }]
    }
};